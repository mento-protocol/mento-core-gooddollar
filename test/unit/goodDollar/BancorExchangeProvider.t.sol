...
import {BancorExchangeProvider} from "contracts/BancorExchangeProvider.sol";
...
contract BancorExchangeProviderTest is Test {
    ...
    function initializeBancorExchangeProvider()
        internal
        returns (BancorExchangeProvider)
    {
        BancorExchangeProvider bancorExchangeProvider = new BancorExchangeProvider(
                false
            );
...
contract BancorExchangeProviderTest_initilizerSettersGetters is
    BancorExchangeProviderTest
{
    ...
    function test_setExitContribution_whenSenderIsNotOwner_shouldRevert()
        public
    {
        vm.prank(makeAddr("NotOwner"));
        vm.expectRevert("Ownable: caller is not the owner");
    ...
    function test_setExitContribution_whenExchangeDoesNotExist_shouldRevert()
        public
    {
        bytes32 exchangeId = "0xexchangeId";
    ...
    function test_setExitContribution_whenExitContributionAbove100Percent_shouldRevert()
        public
    {
        bytes32 exchangeId = bancorExchangeProvider.createExchange(
            poolExchange1
        );
    ...
    function test_setExitContribution_whenSenderIsOwner_shouldUpdateAndEmit()
        public
    {
        bytes32 exchangeId = bancorExchangeProvider.createExchange(
            poolExchange1
        ...
        bancorExchangeProvider.setExitContribution(
            exchangeId,
            newExitContribution
        );

        IBancorExchangeProvider.PoolExchange
            memory poolExchange = bancorExchangeProvider.getPoolExchange(
                exchangeId
            );
    ...
    function test_getPoolExchange_whenExchangeDoesNotExist_shouldRevert()
        public
    {
        bytes32 exchangeId = "0xexchangeId";
    ...
    function test_getExchangeIds_whenNoExchanges_shouldReturnEmptyArray()
        public
        view
    {
    ...
    function test_getExchangeIds_whenExchangesExist_shouldReturnExchangeIds()
        public
    {
        bytes32 exchangeId1 = bancorExchangeProvider.createExchange(
            poolExchange1
        );
    ...
    function test_getExchanges_whenNoExchanges_shouldReturnEmptyArray()
        ...
        view
    {
        IExchangeProvider.Exchange[] memory exchanges = bancorExchangeProvider
            .getExchanges();
        assertEq(exchanges.length, 0);
    }

    function test_getExchanges_whenExchangesExist_shouldReturnExchange()
        public
    {
        bytes32 exchangeId1 = bancorExchangeProvider.createExchange(
            poolExchange1
...
contract BancorExchangeProviderTest_createExchange is
    BancorExchangeProviderTest
{
    BancorExchangeProvider bancorExchangeProvider;
    ...
    function test_createExchange_whenReserveAssetIsNotCollateral_shouldRevert()
        public
    {
        vm.mockCall(
            reserveAddress,
    ...
    function test_createExchange_whenTokenAddressIsNotStable_shouldRevert()
        public
    {
        vm.mockCall(
            reserveAddress,
    ...
    function test_createExchange_whenReserveRatioIsSmaller2_shouldRevert()
        public
    {
    ...
    function test_createExchange_whenReserveRatioAbove100Percent_shouldRevert()
        public
    {
    ...
    function test_createExchange_whenExitContributionAbove100Percent_shouldRevert()
        public
    {
        poolExchange1.exitContribution =
            bancorExchangeProvider.MAX_WEIGHT() +
            1;
        vm.expectRevert("Invalid exit contribution");
        bancorExchangeProvider.createExchange(poolExchange1);
    }

    function test_createExchange_whenExchangeAlreadyExists_shouldRevert()
        public
    {
        bancorExchangeProvider.createExchange(poolExchange1);
    ...
    function test_createExchanges_whenReserveTokenHasMoreDecimalsThan18_shouldRevert()
        public
    {
        vm.mockCall(
            address(reserveToken),
            abi.encodeWithSelector(reserveToken.decimals.selector),
            abi.encode(19)
        );
    ...
    function test_createExchange_whenTokenHasMoreDecimalsThan18_shouldRevert()
        public
    {
        vm.mockCall(
            address(token),
    ...
    function test_createExchange_whenExchangeDoesNotExist_shouldCreateExchangeAndEmit()
        public
    {
        vm.expectEmit(true, true, true, true);
        bytes32 expectedExchangeId = keccak256(
            abi.encodePacked(reserveToken.symbol(), token.symbol())
        );
        ...
        assertEq(
            bancorExchangeProvider.tokenPrecisionMultipliers(
                address(reserveToken)
            ),
            1
        );
        assertEq(
            bancorExchangeProvider.tokenPrecisionMultipliers(address(token)),
            1
        );
    }
}

contract BancorExchangeProviderTest_destroyExchange is
    BancorExchangeProviderTest
{
    BancorExchangeProvider bancorExchangeProvider;
    ...
    function test_destroyExchange_whenExchangeIdAndIndexDontMatch_shouldRevert()
        public
    {
        bytes32 exchangeId = "0xexchangeId";
        bancorExchangeProvider.createExchange(poolExchange1);
    ...
    function test_destroyExchange_whenExchangeExists_shouldDestroyExchangeAndEmit()
        public
    {
        bytes32 exchangeId = bancorExchangeProvider.createExchange(
            poolExchange1
        );
        bytes32 exchangeId2 = bancorExchangeProvider.createExchange(
            poolExchange2
        );
...
contract BancorExchangeProviderTest_getAmountIn is BancorExchangeProviderTest {
    ...
    function test_getAmountIn_whenTokenInIsReserveAsset_shouldReturnCorrectAmount()
        public
    {
        bytes32 exchangeId = bancorExchangeProvider.createExchange(
            poolExchange1
    ...
    function test_getAmountIn_whenTokenInIsToken_shouldReturnCorrectAmount()
        public
    {
        bytes32 exchangeId = bancorExchangeProvider.createExchange(
            poolExchange1
...
contract BancorExchangeProviderTest_getAmountOut is BancorExchangeProviderTest {
    ...
    function test_getAmountOut_whenTokenInIsReserveAsset_shouldReturnCorrectAmount()
        public
    {
        bytes32 exchangeId = bancorExchangeProvider.createExchange(
            poolExchange1
        ...
        uint256 amountIn = bancorExchangeProvider.getAmountOut(
            exchangeId,
            address(reserveToken),
            address(token),
            1e18
    ...
    function test_getAmountOut_whenTokenInIsToken_shouldReturnCorrectAmount()
        public
    {
        bytes32 exchangeId = bancorExchangeProvider.createExchange(
            poolExchange1
...
contract BancorExchangeProviderTest_currentPrice is BancorExchangeProviderTest {
    ...
    function test_currentPrice_whenExchangeExists_shouldReturnCorrectPrice()
        public
    {
        bytes32 exchangeId = bancorExchangeProvider.createExchange(
            poolExchange1
...
contract BancorExchangeProviderTest_swapOut is BancorExchangeProviderTest {
    function test_swapOut_whenCallerIsNotBroker_shouldRevert() public {
        ...
        vm.prank(makeAddr("NotBroker"));
        vm.expectRevert("Caller is not the Broker");
        bancorExchangeProvider.swapOut(
            exchangeId,
            address(reserveToken),
            address(token),
            1e18
