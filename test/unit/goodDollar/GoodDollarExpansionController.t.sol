...
import {GoodDollarExpansionController} from "contracts/GoodDollarExpansionController.sol";
...
import {IDistributionHelper} from "contracts/interfaces/IGoodProtocol.sol";
...
contract GoodDollarExpansionControllerTest is Test {
    ...
    function initializeGoodDollarExpansionController()
        internal
...
contract GoodDollarExpansionControllerTest_initializerSettersGetters is
    GoodDollarExpansionControllerTest
{
    ...
    function test_initializer() public view {
        assertEq(
            address(expansionController.distributionHelper()),
            distributionHelper
        );
        assertEq(expansionController.reserve(), reserveAddress);
        assertEq(
            address(expansionController.goodDollarExchangeProvider()),
            exchangeProvider
        );
    ...
    function test_getExpansionConfig_whenConfigIsSet_shouldReturnConfig()
        public
    {
        ...
        IGoodDollarExpansionController.ExchangeExpansionConfig
            memory config = expansionController.getExpansionConfig(exchangeId);
    ...
    function test_setGoodDollarExchangeProvider_whenSenderIsNotOwner_shouldRevert()
        public
    {
        vm.prank(makeAddr("NotOwner"));
        vm.expectRevert("Ownable: caller is not the owner");
        expansionController.setGoodDollarExchangeProvider(
            makeAddr("NewExchangeProvider")
        );
    }

    function test_setGoodDollarExchangeProvider_whenAddressIsZero_shouldRevert()
        public
    {
    ...
    function test_setGoodDollarExchangeProvider_whenSenderIsOwner_shouldUpdateAndEmit()
        public
    {
    ...
    function test_setDistributionHelper_whenSenderIsNotOwner_shouldRevert()
        public
    {
        vm.prank(makeAddr("NotOwner"));
        vm.expectRevert("Ownable: caller is not the owner");
        expansionController.setDistributionHelper(
            makeAddr("NewDistributionHelper")
        );
    }

    function test_setDistributiomHelper_whenAddressIsZero_shouldRevert()
        public
    {
    ...
    function test_setDistributionHelper_whenCallerIsOwner_shouldUpdateAndEmit()
        public
    {
    ...
    function test_setExpansionConfig_whenSenderIsNotAvatar_shouldRevert()
        public
    {
    ...
    function test_setExpansionConfig_whenExpansionRateIsLargerOrEqualToOne_shouldRevert()
        public
    {
        expansionRate = 1e18;
    ...
    function test_setExpansionConfig_whenExpansionRateIsZero_shouldRevert()
        public
    {
        expansionRate = 0;
    ...
    function test_setExpansionConfig_whenExpansionFrequencyIsZero_shouldRevert()
        public
    {
    ...
    function test_setExpansionConfig_whenCallerIsAvatar_shouldUpdateAndEmit()
        public
    {
        vm.prank(avatarAddress);
        vm.expectEmit(true, true, true, true);
...
contract GoodDollarExpansionControllerTest_mintUBIFromInterest is
    GoodDollarExpansionControllerTest
{
    GoodDollarExpansionController expansionController;
    ...
    function setUp() public override {
        ...
        IBancorExchangeProvider.PoolExchange
            memory pool = IBancorExchangeProvider.PoolExchange({
        ...
        vm.mockCall(
            ...
            abi.encodeWithSelector(
                IGoodDollarExchangeProvider(exchangeProvider)
                    .mintFromInterest
                    .selector
            ),
            abi.encode(1000e18)
        ...
        vm.mockCall(
            exchangeProvider,
            abi.encodeWithSelector(
                IBancorExchangeProvider(exchangeProvider)
                    .getPoolExchange
                    .selector
            ),
            abi.encode(pool)
    ...
    function test_mintUBIFromInterest_whenReserveInterestIs0_shouldRevert()
        public
    {
    ...
    function test_mintUBIFromInterest_whenAmountToMintIsLargerThan0_shouldMintTransferAndEmit()
        public
    {
        ...
        uint256 interestCollectorBalanceBefore = reserveToken.balanceOf(
            interestCollector
        );
        uint256 reserveBalanceBefore = reserveToken.balanceOf(reserveAddress);
        uint256 distributionHelperBalanceBefore = token.balanceOf(
            distributionHelper
        );
        ...
        assertEq(
            reserveToken.balanceOf(reserveAddress),
            reserveBalanceBefore + reserveInterest
        );
        assertEq(
            token.balanceOf(distributionHelper),
            distributionHelperBalanceBefore + amountToMint
        );
        assertEq(
            reserveToken.balanceOf(interestCollector),
            interestCollectorBalanceBefore - reserveInterest
        );
    }
}

contract GoodDollarExpansionControllerTest_mintUBIFromReserveBalance is
    GoodDollarExpansionControllerTest
{
    GoodDollarExpansionController expansionController;
    ...
    function test_mintUBIFromReserveBalance_whenAdditionalReserveBalanceIs0_shouldReturn0()
        public
    {
        deal(address(reserveToken), reserveAddress, pool.reserveBalance);
        uint256 amountMinted = expansionController.mintUBIFromReserveBalance(
            exchangeId
        );
        assertEq(amountMinted, 0);
    }

    function test_mintUBIFromReserveBalance_whenAdditionalReserveBalanceIsLargerThan0_shouldMintAndEmit()
        public
    {
        uint256 amountToMint = 1000e18;
        ...
        deal(
            ...
            reserveAddress,
            pool.reserveBalance + additionalReserveBalance
        );
...
contract GoodDollarExpansionControllerTest_mintUBIFromExpansion is
    GoodDollarExpansionControllerTest
{
    GoodDollarExpansionController expansionController;
    ...
    function setUp() public override {
        ...
        vm.mockCall(
            distributionHelper,
            abi.encodeWithSelector(
                IDistributionHelper(distributionHelper).onDistribution.selector
            ),
            abi.encode(true)
        );
    }

    function test_mintUBIFromExpansion_whenExpansionConfigIsNotSet_shouldRevert()
        public
    {
        vm.expectRevert("Expansion config not set");
    ...
    function test_mintUBIFromExpansion_whenShouldNotExpand_shouldNotExpand()
        public
    {
    ...
    function test_mintUBIFromExpansion_whenFirstExpansionAndLessThanExpansionFrequencyPassed_shouldExpand1Time()
        public
    {
        ...
        IGoodDollarExpansionController.ExchangeExpansionConfig
            memory config = expansionController.getExpansionConfig(exchangeId);
        assert(
            block.timestamp < config.lastExpansion + config.expansionFrequency
        );
        ...
        uint256 amountMinted = expansionController.mintUBIFromExpansion(
            exchangeId
        );
        ...
        public
    {
        ...
        assert(
            block.timestamp >
                config.lastExpansion + config.expansionFrequency * 3
        );
        uint256 expansionScaler = 1e18 * 0.99;
        uint256 amountToMint = 1000e18;
        uint256 distributionHelperBalanceBefore = token.balanceOf(
    ...
    function test_mintUBIFromExpansion_when1DayPassed_shouldCalculateCorrectRateAndExpand()
        public
    {
        // doing one initial expansion to not be first expansion
        // since on first expansion the expansion is always applied once.
    ...
    function test_mintUBIFromExpansion_whenMultipleDaysPassed_shouldCalculateCorrectRateAndExpand()
        public
    {
        // doing one initial expansion to not be first expansion
        // since on first expansion the expansion is always applied once.
...
contract GoodDollarExpansionControllerTest_mintRewardFromRR is
    GoodDollarExpansionControllerTest
{
    GoodDollarExpansionController expansionController;
    ...
    function test_mintRewardFromRR_whenCallerIsNotAvatar_shouldRevert() public {
        vm.prank(makeAddr("NotAvatar"));
        vm.expectRevert("Only Avatar can call this function");
        expansionController.mintRewardFromRR(
            exchangeId,
            makeAddr("To"),
            1000e18
        );
    ...
    function test_mintRewardFromRR_whenCallerIsAvatar_shouldMintAndEmit()
        public
    {
        uint256 amountToMint = 1000e18;
